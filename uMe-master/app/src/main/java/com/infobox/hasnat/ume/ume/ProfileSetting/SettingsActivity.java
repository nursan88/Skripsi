    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getUserDatabaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                //String bilangan_g = dataSnapshot.child("bilangan_g").getValue().toString();
                //String bilangan_y = dataSnapshot.child("bilangan_y").getValue().toString();
                //String bilangan_x = dataSnapshot.child("bilangan_x").getValue().toString();
                //String bilangan_p_pub = dataSnapshot.child("bilangan_p_pub").getValue().toString();
                //String bilangan_p = dataSnapshot.child("bilangan_p").getValue().toString();
                ...
                //bilangan_p_priv.setText(bilangan_p);
                //bilangan_p_pub.setText(bilangan_p);
                //bil_g.setText(bilangan_g);
                //bil_x.setText(bilangan_x);
                //bil_y.setText(bilangan_y);

                //bilangan_p_priv.setText();
