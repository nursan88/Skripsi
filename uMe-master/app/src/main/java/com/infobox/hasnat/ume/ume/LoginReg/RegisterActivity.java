                    ...
                    .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            ...
                            if (task.isSuccessful()){
                                ...
                                // Mengambil nilai x, g, p dan y
                                GenerateKey generateKey = new GenerateKey();
                                HitungY hitungY = new HitungY(generateKey);
                                ...
                                storeDefaultDatabaseReference.child("bilangan_g").setValue(generateKey.BilG);
                                storeDefaultDatabaseReference.child("bilangan_y").setValue(hitungY.y);
                                storeDefaultDatabaseReference.child("bilangan_x").setValue(generateKey.BilX);
                                storeDefaultDatabaseReference.child("bilangan_p").setValue(generateKey.bilprim);
